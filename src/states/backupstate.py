...
class BackupState(AppState):
    ...
    def create_backup(self):
        ...
        try:
            ...
            self.log_manager.log(self.context.username, "Backup", f"Error creating backup: {e}", True)
    ...
    def _restore_file(self, backup_name):
        ...
        try:
            ...
            self.log_manager.log(self.context.username, "Backup", f"Error restoring backup: {e}", True)
