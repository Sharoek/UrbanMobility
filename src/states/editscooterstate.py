...
class editScooterState(AppState):
    ...
    def display_scooter_list(self):
        ...
        try:
            ...
            self.log_manager.log(self.context.username, "Invalid choice", f"Invalid choice: {choice}")
    ...
    def scooter_submenu(self, selected_scooter):
        ...
        try:
            ...
            self.log_manager.log(self.context.username, "Error", f"Error: {e}")
            print(f"[✖] Error: {e}")
    ...
    def edit_model(self, selected_scooter: Scooter):
        ...
        if validate_model(new_model):
            ...
            try:
                ...
                self.log_manager.log(self.context.username, "Updated model", f"Updated model: {new_model}")
            except Exception as e:
                print(f"[✖] Error updating model: {e}")
                self.log_manager.log(self.context.username, "Error updating model", f"Error updating model: {e}")
        else:
    ...
    def edit_serial_number(self, selected_scooter: Scooter):
        ...
        if validate_serial_number(new_serial_number):
            ...
            try:
                ...
                self.log_manager.log(self.context.username, "Updated serial number", f"Updated serial number: {new_serial_number}")
            except Exception as e:
                print(f"[✖] Error updating serial number: {e}")
                self.log_manager.log(self.context.username, "Error updating serial number", f"Error updating serial number: {e}")
        else: 
    ...
    def edit_top_speed(self, selected_scooter: Scooter):
        ...
        try:
            ...
            self.log_manager.log(self.context.username, "Updated top speed", f"Updated top speed: {new_top_speed}")
        except Exception as e:
            print(f"[✖] Error updating top speed: {e}")
            self.log_manager.log(self.context.username, "Error updating top speed", f"Error updating top speed: {e}")
    ...
    def edit_battery_capacity(self, selected_scooter: Scooter):
        ...
        try:
            ...
            self.log_manager.log(self.context.username, "Updated battery capacity", f"Updated battery capacity: {new_battery_capacity}")
        except Exception as e:
            print(f"[✖] Error updating battery capacity: {e}")
            self.log_manager.log(self.context.username, "Error updating battery capacity", f"Error updating battery capacity: {e}")
    ...
    def edit_brand(self, selected_scooter: Scooter):
        ...
        if validate_brand(new_brand):
            ...
            try:
                ...
                self.log_manager.log(self.context.username, "Updated brand", f"Updated brand: {new_brand}")
            except Exception as e:
                print(f"[✖] Error updating brand: {e}")
                self.log_manager.log(self.context.username, "Error updating brand", f"Error updating brand: {e}")
        else:
    ...
    def soc(self, selected_scooter: Scooter):
        ...
        try:
            ...
            self.log_manager.log(self.context.username, "Updated State of Charge", f"Updated State of Charge: {new_soc}%")
        except Exception as e:
            print(f"[✖] Error updating State of Charge: {e}")
            self.log_manager.log(self.context.username, "Error updating State of Charge", f"Error updating State of Charge: {e}")
    ...
    def sub_menu_last_maintenance(self, selected_scooter: Scooter):
        ...
        try:
            if validate_last_maintanence(new_date, prev_date):
                ...
                self.log_manager.log(self.context.username, "Updated Last Maintenance Date", f"Updated Last Maintenance Date: {new_date}")
        except Exception as e:
            print(f"[✖] Error updating Last Maintenance Date: {e}")
            self.log_manager.log(self.context.username, "Error updating Last Maintenance Date", f"Error updating Last Maintenance Date: {e}")   
    ...
    def sub_menu_mileage(self, selected_scooter: Scooter):
        ...
        try:
            ...
            self.log_manager.log(self.context.username, "Updated Mileage", f"Updated Mileage: {new_mileage} km")
        except Exception as e:
            print(f"[✖] Error updating Mileage: {e}")
            self.log_manager.log(self.context.username, "Error updating Mileage", f"Error updating Mileage: {e}")
    ...
    def sub_menu_soc(self, selected_scooter: Scooter):
        ...
        if choice == 1:
            ...
            try:
                ...
                self.log_manager.log(self.context.username, "Updated Minimum SoC", f"Updated Minimum SoC: {new_min_soc}%")
            except Exception as e:
                print(f"[✖] Error updating Minimum SoC: {e}")
                self.log_manager.log(self.context.username, "Error updating Minimum SoC", f"Error updating Minimum SoC: {e}")
        elif choice == 2:
            ...
            try:
                ...
                self.log_manager.log(self.context.username, "Updated Maximum SoC", f"Updated Maximum SoC: {new_max_soc}%")
            except Exception as e:
                print(f"[✖] Error updating Maximum SoC: {e}")
                self.log_manager.log(self.context.username, "Error updating Maximum SoC", f"Error updating Maximum SoC: {e}")
        else:
            print("Invalid choice. Please try again.")
        if choice == 0:
            return
    ...
    def sub_menu_location(self, selected_scooter: Scooter):
        ...
        if choice == 1:
            ...
            try:
                ...
                self.log_manager.log(self.context.username, "Updated Latitude", f"Updated Latitude: {new_latitude}")
            except Exception as e:
                print(f"[✖] Error updating Latitude: {e}")
                self.log_manager.log(self.context.username, "Error updating Latitude", f"Error updating Latitude: {e}")
        elif choice == 2:
            ...
            try:
                ...
                self.log_manager.log(self.context.username, "Updated Longitude", f"Updated Longitude: {new_longitude}")
            except Exception as e:
                print(f"[✖] Error updating Longitude: {e}")
                self.log_manager.log(self.context.username, "Error updating Longitude", f"Error updating Longitude: {e}")
        else:
            print("Invalid choice. Please try again.")
        if choice == 0:
            return
    ...
    def out_of_service_status(self, selected_scooter: Scooter):
        ...
        if choice == 1:
            ...
            try:
                ...
                self.log_manager.log(self.context.username, "Updated Out of Service Status", f"Updated Out of Service Status: {selected_scooter.out_of_service_status}")
            except Exception as e:
                print(f"[✖] Error setting Out of Service: {e}")
                self.log_manager.log(self.context.username, "Error updating Out of Service Status", f"Error updating Out of Service Status: {e}")
        elif choice == 2:
