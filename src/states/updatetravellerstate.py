    ...
    def print_update_menu(self, traveller):
        ...
        if choice == 0:
            ...
            try:
                ...
                print(f"An error occurred: {e}")
                self.log_manager.log(self.context.username, "Error updating first name", str(e), True)
                return
        elif choice == 2:
            try:
                ...
                print(f"An error occurred: {e}")
                self.log_manager.log(self.context.username, "Error updating last name", str(e), True)
                return
        elif choice == 3:
            try:
                ...
                print(f"An error occurred: {e}")
                self.log_manager.log(self.context.username, "Error updating gender", "", True)
                return
        elif choice == 4:
            try:
                ...
                print(f"An error occurred: {e}")
                self.log_manager.log(self.context.username, "Error updating street name", str(e), True)
                return
        elif choice == 5:
            try:
                ...
                print(f"An error occurred: {e}")
                self.log_manager.log(self.context.username, "Error updating house number", str(e), True)
                return
        elif choice == 6:
            try:
                ...
                print(f"An error occurred: {e}")
                self.log_manager.log(self.context.username, "Error updating zip code", str(e), True)
                return
        elif choice == 7:
            try:
                ...
                print(f"An error occurred: {e}")
                self.log_manager.log(self.context.username, "Error updating city", str(e), True)
                return
        elif choice == 8:
            try:
                ...
                print(f"An error occurred: {e}")
                self.log_manager.log(self.context.username, "Error updating email address", str(e), True)
                return
        elif choice == 9:
            try:
                ...
                print(f"An error occurred: {e}")
                self.log_manager.log(self.context.username, "Error updating mobile phone", str(e), True)
                return
        elif choice == 10:
            try:
                ...
                print(f"An error occurred: {e}")
                self.log_manager.log(self.context.username, "Error updating driving license number", str(e), True)
                return
        else:
