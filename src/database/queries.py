...
SEARCH_SCOOTER = "SELECT * FROM scooters WHERE brand LIKE ? OR id LIKE ? OR model LIKE ? OR top_speed LIKE ? OR battery_capacity LIKE ? OR state_of_charge LIKE ? OR min_soc LIKE ? OR max_soc LIKE ?  OR mileage LIKE ?;"
